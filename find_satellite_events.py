...
def write_to_csv_file(in_file_name: str, in_config_section: str, in_days: List[DayTransits], ignore_day: bool) -> None:
...
def parse_arguments(in_args):
	...
	in_alt_amt = getattr(in_args, "alt", 30.)
...
def main(input_args) -> None:
	n_days, reload_sat, input_tz, use_all_, in_alt_amt, in_config_section, ignore_day = parse_arguments(input_args)
	today_utc = today()
	...
	write_to_csv_file("culmination_output.csv", in_config_section, culmination_data, ignore_day)
...
if __name__ == "__main__":
	...
	parser.add_argument(
		'-a', '--alt', nargs=1, type=float, default=30.,
